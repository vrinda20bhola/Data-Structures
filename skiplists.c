// Skip Lists
 // having trouble writing the code of skip lists and undestanding the concept in complete detail 
 //Hence, this code is from the internet.
...
int main() { /// calling alll functions
